...
<div class="col-sm-8">
    ...
    <ul>
    <li>A Criminal Record Check with ‘no criminal record’ is required. Cost is reimbursed; just provide your receipt.</li>
    ...
    <p>GROW Workshop Assistants will observe the positive effects of their presence when they observe:</p>
    <ul>
    <li>Students excited about healthy food and keen to try new things</li>
    <li>Increased awareness of food systems, food security and the importance of food in culture</li>
    ...
    <li>Attend a GROW Project training (This may occur at the same time as the Loving Spoonful Orientation, or be conducted prior to your first workshop.)</li>
    </ul>
</div>
@endsection
